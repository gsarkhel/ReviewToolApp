    ...
    <div class="container-fluid d-flex align-items-center">
      ...
      <div class="d-flex align-items-center">
        {{-- <span class="navbar-brand">
            <a href="{{ route('admin.courses') }}" class="btn btn-secondary btn-sm me-2">
                <i class="fa fa-arrow-left" aria-hidden="true"></i>
            </a>
            Course
        </span> --}}
        <button onclick="location.href='{{ route('admin.courses') }}'" type="button" class="btn btn-return me-2">
          Back
        </button>
      ...
      <div class="ms-auto navbar-buttons">
        <a href="{{ route('admin.view_comments', ['id' => $course->id]) }}" class="btn btn-gradient" style="width: 200px;">View Comments</a>
        <!-- Profile Logo Button -->
            ...
            <div class="card-body">
                ...
                @if($course->is_deleted == 1)
                    <div class="alert alert-warning">
                        <strong>Notice:</strong> This course has been deleted. You can only view the comments.
                    </div>
                @else
  ...
  <script>
    ...
    function openOrFocusTab(courseId) {
        ...
        if (openTabs[tabKey] && !openTabs[tabKey].closed) {
            ...
            const url = `/admin/view_comments/${courseId}`;
