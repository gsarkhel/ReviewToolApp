...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-gradient">
    <div class="container-fluid d-flex align-items-center">
      ...
      <div class="d-flex align-items-center">
        <!-- <a href="login.html" class="logout-btn me-2">Logout</a> -->
        <span class="navbar-brand">course</span>
      </div>
      <!-- Right side: View Comments button and Profile Logo -->
      <div class="ms-auto navbar-buttons">
        <a href="Comment_list_page.html" class="btn btn-gradient">View Comments</a>
        <!-- Profile Logo Button -->
  ...
  <div class="upload-container">
    <!-- Trigger the View Course modal -->
    <a href="{{ route('author.courses') }}" class="btn btn-gradient">View Course</a>
