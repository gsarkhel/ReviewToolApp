...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-gradient">
    <div class="container-fluid d-flex align-items-center">
      ...
      <div class="d-flex align-items-center">
        ...
        <button onclick="location.href='{{ route('author.courses') }}'" type="button" class="btn btn-return me-2">
          Back
        </button>
      ...
      <div class="ms-auto navbar-buttons">
        <!-- <a href="{{ route('author.view_comments', ['id' => $course->id]) }}" class="btn btn-gradient" style="width: 200px;">View Comments</a> -->
        <a href="{{ url('author/view_comments', ['id' => $course->id]) }}" class="btn btn-gradient" style="width: 200px;">View Comments</a>
        <!-- Profile Logo Button -->
        <div class="header_user_thumb">
          <a href="#" class="header_thumb_link">
           ...
           <ul class="header_menu_dropdown" href="#">
               <li><a href="{{ route('author.userprofile') }}">User Profile</a></li>
  ...
  <div class="content p-0">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
              <iframe src="{{ $scormUrl }}?access_token={{ $accessToken }}&course_uuid={{ $course->uuid }}&add_comment=false" width="100%" height="800px" style="border: none;"></iframe>
            </div>
        </div>
    </div>
  </div>
  ...
  <script>
    ...
    function openOrFocusTab(courseId) {
        ...
        if (openTabs[tabKey] && !openTabs[tabKey].closed) {
            ...
            const url = `{{ url('author/view_comments') }}/${courseId}`;
