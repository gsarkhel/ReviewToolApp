...
<html lang="en">
  ...
  <body>
    ...
    <div class="container table-container">
      <form method="GET" action="{{ route('author.view_comments', ['id' => $course_id]) }}">
        @csrf
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        updateButtons.forEach((btn) => {
          btn.addEventListener("click", function () {
            ...
            fetch(baseUrl+`/get-comment-details/${courseId}/${commentId}`)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        let baseUrl = "{{ url('/') }}";
                        document.getElementById("editcommentform").action = `${baseUrl}/author/editcomment/${comment.comment.id}/${courseId}`;
