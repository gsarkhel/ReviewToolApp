...
{{-- {{dd($filter_page_no)}} --}}
    ...
    <div class="container table-container">
      <form id="filter-form" method="GET" action="{{ route('reviewer.view_comments', ['id' => $course_id]) }}">
        ...
        <input id="show" name="show" type="hidden" value="s"/>
        ...
        <div class="d-flex gap-3 flex-wrap align-items-end">
          <div class="mb-3">
            <button id="course" type="button" class="custom-filter btn btn-gradient w-100 mt-2">Course</button>
        </div>
        <div class="mb-3">
          <button id="module" type="button" class="custom-filter btn btn-gradient w-100 mt-2">Module</button>
      </div>
      <div class="mb-3">
        <button id="screen" type="button" class="custom-filter btn btn-gradient w-100 mt-2">Screen</button>
    </div>
          <!-- Filter by Status -->
