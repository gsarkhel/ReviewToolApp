						...
						t.clickToPlayPauseCallback = function() {
							...
							if (t.options.clickToPlayPause) {
								if (t.media.paused) {
									...
									t.pause();
									//$('body').addClass('human_paused_video'); // Mrinmoy's line
								}
							}
						};
		...
		buildplaypause: function(player, controls, layers, media) {
			var 
				...
				$('<div class="mejs-button mejs-playpause-button mejs-play" >' +
					'<button type="button" aria-controls="' + t.id + '" title="" aria-label="' + t.options.playpauseText + '"></button>' +
				'</div>')
				.appendTo(controls)
				.click(function(e) {

					//mrinmoy's code
/* 					if($(this).parent().parent().parent().hasClass('mejs-video')){
						if($(this).hasClass('mejs-pause')){
							if(e.originalEvent !== undefined) {
								$('body').addClass('human_paused_video');
							} 
						} else{
							if (e.originalEvent !== undefined){
								$('body').removeClass('human_paused_video');
							}
						}
					} */
					//mrinmoy's code ends
		...
		buildprogress: function(player, controls, layers, media) {
			...
			total
				.bind('mousedown touchstart', function (e) {
					// only handle left clicks or touch (seekbar controls edited by G.Thulasi)
					 
					if(seekbarControls != "disabled"){
						$('.mejs-controls .mejs-time-rail .mejs-time-float-corner, .mejs-time-float, .mejs-controls .mejs-time-rail span, .mejs-time-rail').css('cursor','pointer');
						...
						$('.mejs-controls .mejs-time-rail .mejs-time-float-corner, .mejs-time-float, .mejs-controls .mejs-time-rail span, .mejs-time-rail').css('cursor','default');
					}
				})
		...
		buildvolume: function(player, controls, layers, media) {
			...
			var t = this,
				...
				$('<div class="mejs-button mejs-volume-button mejs-mute">'+
					'<button type="button" aria-controls="' + t.id + '" title="" aria-label="' + t.options.muteText + '"></button>'+
				'</div>' +
			...
			var t = this,
				...
				fullscreenBtn =
					$('<div class="mejs-button mejs-fullscreen-button">' +
						'<button type="button" aria-controls="' + t.id + '" title="" aria-label="' + t.options.fullscreenText + '"></button>' +
					'</div>')
					.appendTo(controls);
		...
		buildtracks: function(player, controls, layers, media) {
			...
			player.captionsButton =
					$('<div class="mejs-button mejs-captions-button">'+
						'<button type="button" aria-controls="' + t.id + '" title="" aria-label="' + t.options.tracksText + '"></button>'+
